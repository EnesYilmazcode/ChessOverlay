...
## Checking it still works
    ...
    python piecetest.py     25 checks on the piece reader under a bad capture
...
The first three need nothing but the fixtures. The last four take over the
screen, so run them when you are not using the machine.
